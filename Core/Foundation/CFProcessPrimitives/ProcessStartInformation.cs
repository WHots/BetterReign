...
namespace Morningstar.Core.Foundation.ProcessOperations
{
    ...
    internal class ProcessEnviroment : ProcessStartInformation
    {
        ...
        private void processEnded(object sender, System.EventArgs e)
        {          
            MessageBox.Show("Process had be closed!");
        }
        ...
        {          
            ...
            userStartedProcess.Exited += new EventHandler(processEnded);
