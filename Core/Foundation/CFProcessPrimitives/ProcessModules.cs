    ...
    abstract class ProcessModules
    {
        ...
        internal bool GetModules(int pid)
        {
            ...
            for (int i = 0; i < myProcessModuleCollection.Count; i++)
            {
                ...
                IntPtr entrypoint = processModule.EntryPointAddress;
                string entrypointhex = string.Format("{0:x}", (entrypoint.ToInt64()));

                //  [0] = Entry Adress
                //  [1] = Base Adress
                //  [2] = Name             
                ModuleNames.Add(entrypointhex + "," + processModule.BaseAddress + "," + processModule.ModuleName);
            }
